...
const MyPostWidget = ({ picturePath }) => {
    ...
    return (
        <WidgetWrapper borderRadius="3%" sx={{ boxShadow: 4 }}>
            <FlexBetween gap="1.5rem">
                ...
                >
                    <Dropzone
                        ...
                        multiple={false}
                        onDrop={(acceptedFiles) => setImage(acceptedFiles[0]) // because of dropzone, i need to set the field values manually
                        }
                    >
            ...
            <Divider sx={{ margin: "1.25rem 0" }}  />
                ...
                <InputBase
                    disabled={!image}
                    placeholder="Talk about your image..."
                ...
                {isNonMobileScreeen ? (
                    <>
                        ...
                        <FlexBetween gap="0.25rem" sx= {{ "&:hover": { cursor: "pointer", color: medium } }}>
                            ...
                            <Typography color={mediumMain} >Audio message</Typography>
